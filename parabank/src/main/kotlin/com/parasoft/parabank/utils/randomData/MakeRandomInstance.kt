import com.parasoft.parabank.utils.randomData.getKType
...
class RandomInstanceProducer(
    ...
    private fun makeRandomList(classRef: KClass<*>, type: KType): List<Any?> {
        val numOfElements =
            random.nextInt(config.possibleCollectionSizes.start, config.possibleCollectionSizes.endInclusive + 1)
